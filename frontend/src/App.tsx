      ...
      case 'landing':
        return (
          <div className="space-y-8 text-center py-12">
            <div>
              <img src={logoImg} alt="Korsh" className="w-20 h-20 rounded-3xl mx-auto mb-6" />
              <h1 className="text-3xl font-bold">Korsh Wallet</h1>
            ...
            <div className="card bg-dark-800/50 text-left max-w-md mx-auto space-y-3">
              <h3 className="text-sm font-semibold text-ksh-400">Self-Custody Wallet</h3>
