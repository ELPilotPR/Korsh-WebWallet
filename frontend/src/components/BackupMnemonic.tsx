  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card bg-dark-800">
        ...
        <button
          onClick={handleCopy}
          className="mt-4 w-full py-2.5 rounded-xl text-sm font-medium transition-colors border border-dark-600 hover:border-ksh-500 hover:text-ksh-400 text-dark-300"
        >
      ...
      <label className="flex items-start gap-3 cursor-pointer">
        <input
          type="checkbox"
          className="mt-1 w-4 h-4 rounded border-dark-600 bg-dark-800 text-ksh-500
                     focus:ring-ksh-500 focus:ring-offset-0"
          checked={confirmed}
